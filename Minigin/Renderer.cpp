...
void dae::Renderer::Render() const
{
	...
	//if using imgui, make imgui components that can be added and be rendered instead of doing it here!
#pragma region Testing ImGui (ToBeReworkedIfUsed)
//	// ======= ADD GUI HERE ========
...
//	ImGui::End();
//
#pragma endregion Testing ImGui (ToBeReworkedIfUsed)
