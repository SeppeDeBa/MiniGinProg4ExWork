...
void dae::MoveCommand::Execute(float deltaTime)
{
	...
	if (m_pGameObject!=nullptr) m_pGameObject->GetComponent<dae::Transform>()->AddToLocalPosition(m_DirectionVector.x * m_Speed * deltaTime , (m_DirectionVector.y*-1) * m_Speed * deltaTime); //inverting direction vector because y.0 = at the top of the screen
}
